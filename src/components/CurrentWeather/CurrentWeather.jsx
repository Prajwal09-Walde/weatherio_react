...
const CurrentWeather = ({onClose, city}) => {
    ...
    // }
    return (
        <div className='weather h-1/4 fixed top-2/4 left-2/4 translate-x-2/4 translate-y-1/2 leading-6 px-4 py-7 rounded-sm max-w-100 min-w-60 border border-black text-black shadow-lg'>
            {weather && (
